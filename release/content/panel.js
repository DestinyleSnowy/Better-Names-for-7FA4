...
(function () {
  ...
  BN.panel.initialize = async function initializePanel() {
    'use strict';
  ...
  const autoRenew = BN.autoRenew || {};
  if (typeof autoRenew.pruneMemory === 'function') {
    autoRenew.pruneMemory();
  }
  if (typeof autoRenew.handleRedirect === 'function' && autoRenew.handleRedirect(enableAutoRenew)) {
    return;
  }
  ...
  if (enableAutoRenew && typeof autoRenew.init === 'function') autoRenew.init();
  ...
  const users = {
    ...
    2851: { name: "张振瀚", colorKey: "by" },
    2852: { name: "黄羿信", colorKey: "c2" },
    2853: { name: "孙传智", colorKey: "c3" },
    2854: { name: "胡瑞可", colorKey: "g1" },
    2855: { name: "陈恺寰", colorKey: "by" },
    2856: { name: "赵旭初", colorKey: "g2" },
    2857: { name: "袁振兴", colorKey: "g1" },
    2858: { name: "汪穆清", colorKey: "g1" },
    2859: { name: "张奕源", colorKey: "g1" },
    2860: { name: "张天澍", colorKey: "g2" },
    2861: { name: "蔡嘉轩", colorKey: "c2" },
    2862: { name: "周乐达", colorKey: "g2" },
    2863: { name: "程梁", colorKey: "c3" },
    2864: { name: "路晋玮", colorKey: "by" },
    2865: { name: "董家澍", colorKey: "by" },
    2866: { name: "贾智梦", colorKey: "c3" },
    2867: { name: "李泽圻", colorKey: "c3" },
    2868: { name: "李璐彤", colorKey: "c3" },
    2869: { name: "李沐阳", colorKey: "c3" },
    2870: { name: "李澍", colorKey: "g2" },
    2871: { name: "刘泓杨", colorKey: "c3" },
    2872: { name: "李子晨", colorKey: "c2" },
    2873: { name: "焦楚恒", colorKey: "g1" },
    2874: { name: "路田宇", colorKey: "c3" },
    2875: { name: "马铭李", colorKey: "g1" },
    2876: { name: "钱万朗", colorKey: "c3" },
    2877: { name: "任逸", colorKey: "c3" },
    2878: { name: "崔博铭", colorKey: "c3" },
    2879: { name: "汤浩辰", colorKey: "c3" },
    2880: { name: "田囿骐", colorKey: "c3" },
    2881: { name: "王一同", colorKey: "c3" },
    2882: { name: "尤朔涵", colorKey: "c3" },
    2883: { name: "王天琢", colorKey: "g1" },
    2884: { name: "王思源", colorKey: "g1" },
    2885: { name: "赵柏晗", colorKey: "g2" },
    2886: { name: "黄奕涵", colorKey: "g1" },
    2887: { name: "吕明睿", colorKey: "g1" },
    2888: { name: "朱鹏睿", colorKey: "g3" },
    2889: { name: "杨亚凡", colorKey: "c3" },
    2890: { name: "易佳睿", colorKey: "by" },
    2891: { name: "钟天睿", colorKey: "c3" },
    2892: { name: "虞辰睿", colorKey: "g1" },
    2893: { name: "张斯垚", colorKey: "g1" },
    2894: { name: "陈瓒", colorKey: "c3" },
    2895: { name: "秦颢睿", colorKey: "c3" },
    2896: { name: "余施祁", colorKey: "by" },
    2897: { name: "罗锐", colorKey: "by" },
    2898: { name: "管子航", colorKey: "g2" },
    2899: { name: "易天扬", colorKey: "c3" },
    2900: { name: "项艺程", colorKey: "by" },
    2901: { name: "孙梓珊", colorKey: "g1" },
    2902: { name: "文启鑫", colorKey: "g1" },
    2903: { name: "张屹弛", colorKey: "c3" },
    2904: { name: "黄怀谨", colorKey: "by" },
    2905: { name: "毛晋南", colorKey: "c3" },
    2906: { name: "丁雍哲", colorKey: "g2" },
    2907: { name: "陈泽宇", colorKey: "c3" },
    2908: { name: "史嘉涵", colorKey: "g2" },
    2909: { name: "伏思奕", colorKey: "c2" },
    2910: { name: "蒋珺", colorKey: "c3" },
    2911: { name: "吴逸翔", colorKey: "c3" },
    2912: { name: "李堂睿", colorKey: "c3" },
    2913: { name: "刘紫琪", colorKey: "c2" },
    2914: { name: "李闻希", colorKey: "c3" },
    2915: { name: "罗恩皓", colorKey: "g2" },
    2916: { name: "马铭宇", colorKey: "c2" },
    2917: { name: "阮少川", colorKey: "c3" },
    2918: { name: "时玄哲", colorKey: "c2" },
    2919: { name: "张家澍", colorKey: "c3" },
    2920: { name: "彭鑫博", colorKey: "g1" },
    2921: { name: "王嘉瑞", colorKey: "by" },
    2922: { name: "拿不拿", colorKey: "g2" },
    2923: { name: "肖晋依", colorKey: "c3" },
    2924: { name: "徐子谦", colorKey: "c3" },
    2925: { name: "陶一维", colorKey: "c2" },
    2926: { name: "幺智远", colorKey: "g2" },
    2927: { name: "袁清扬", colorKey: "c3" },
    2928: { name: "谭正清", colorKey: "c3" },
    2929: { name: "曾昱乔", colorKey: "c2" },
    2930: { name: "张梵熙", colorKey: "c3" },
    2931: { name: "张晏玮", colorKey: "c3" },
    2932: { name: "张哲熙", colorKey: "c3" },
    2933: { name: "武林", colorKey: "g3" },
    2934: { name: "周盛椿", colorKey: "c2" },
    2935: { name: "周学瑾", colorKey: "c2" },
    2936: { name: "朱浩宇", colorKey: "c3" },
    2937: { name: "陈潇", colorKey: "g2" },
    2938: { name: "邹锦舒", colorKey: "g1" },
    2939: { name: "丁子轩", colorKey: "c3" },
    2940: { name: "张辰烁", colorKey: "c3" },
    2941: { name: "彭曾子炫", colorKey: "c1" },
    2942: { name: "曹茗峻", colorKey: "g1" },
    2943: { name: "王子煊", colorKey: "g1" },
    2944: { name: "李梓豪", colorKey: "c3" },
    2945: { name: "贾径欢", colorKey: "g1" },
    2946: { name: "周钰子", colorKey: "g1" },
    2947: { name: "邓泽灏", colorKey: "c3" },
    2948: { name: "蔡梦晨", colorKey: "c1" },
    2949: { name: "贾涛语", colorKey: "c3" },
    2950: { name: "曾占元", colorKey: "by" },
    2951: { name: "陈翌豪", colorKey: "c1" },
    2952: { name: "陈韵霖", colorKey: "g3" },
    2953: { name: "范奕铭", colorKey: "by" },
    2954: { name: "冯宇宸", colorKey: "by" },
    2955: { name: "黄郑纳新", colorKey: "by" },
    2956: { name: "胡岑昊", colorKey: "c2" },
    2957: { name: "胡昊泽", colorKey: "g2" },
    2958: { name: "胡旻隽", colorKey: "by" },
    2959: { name: "江政楠", colorKey: "by" },
    2960: { name: "施志浩", colorKey: "by" },
    2961: { name: "柯淑涵", colorKey: "c1" },
    2962: { name: "李弘钧", colorKey: "c2" },
    2963: { name: "傅九瑞", colorKey: "g2" },
    2964: { name: "董新淇", colorKey: "c3" },
    2965: { name: "李佳谕", colorKey: "g1" },
    2966: { name: "周尚逸", colorKey: "by" },
    2967: { name: "李南憙", colorKey: "by" },
    2968: { name: "刘思勋", colorKey: "c1" },
    2969: { name: "刘珈逸", colorKey: "g1" },
    2970: { name: "姜祉旭", colorKey: "c1" },
    2971: { name: "刘欣媛", colorKey: "g1" },
    2972: { name: "王鹏程", colorKey: "g1" },
    2973: { name: "刘亦家", colorKey: "by" },
    2974: { name: "柳子宁", colorKey: "g2" },
    2975: { name: "李瑞涵", colorKey: "c3" },
    2976: { name: "李昕颐", colorKey: "by" },
    2977: { name: "徐玺源", colorKey: "g1" },
    2978: { name: "魏天澜", colorKey: "c1" },
    2979: { name: "彭卓远", colorKey: "g2" },
    2980: { name: "荣天赫", colorKey: "by" },
    2981: { name: "赵启暄", colorKey: "g2" },
    2982: { name: "苏锦尚", colorKey: "by" },
    2983: { name: "喻嘉皓", colorKey: "g2" },
    2984: { name: "张峻瑜", colorKey: "d4" },
    2985: { name: "张洵越", colorKey: "g1" },
    2986: { name: "陈佳雨", colorKey: "g1" },
    2987: { name: "陈鑫睿", colorKey: "g3" },
    2988: { name: "丁敬轩", colorKey: "g2" },
    2989: { name: "董百柯", colorKey: "c3" },
    2990: { name: "方飞", colorKey: "g2" },
    2991: { name: "高晨瀚", colorKey: "g1" },
    2992: { name: "葛澎达", colorKey: "g1" },
    2993: { name: "韩绍峰", colorKey: "c1" },
    2994: { name: "董一瑄", colorKey: "g2" },
    2995: { name: "韩靖颢", colorKey: "d1" },
    2996: { name: "黄钰淳", colorKey: "g2" },
    2997: { name: "陈雨翔", colorKey: "g1" },
    2998: { name: "蒋成栋", colorKey: "g1" },
    2999: { name: "蒋承哲", colorKey: "c1" },
    3000: { name: "金曈煊", colorKey: "c3" },
    3001: { name: "李睿涵", colorKey: "c3" },
    3002: { name: "李天佑", colorKey: "c3" },
    3003: { name: "张恩瑞", colorKey: "c3" },
    3004: { name: "欧阳鑫星", colorKey: "g2" },
    3005: { name: "李鸿骞", colorKey: "by" },
    3006: { name: "刘北辰", colorKey: "c3" },
    3007: { name: "刘青阳", colorKey: "g1" },
    3008: { name: "刘焘畅", colorKey: "c3" },
    3009: { name: "路子熙", colorKey: "c3" },
    3010: { name: "余瑑", colorKey: "c2" },
    3011: { name: "莫博文", colorKey: "g2" },
    3012: { name: "欧翟钞", colorKey: "by" },
    3013: { name: "潘睿", colorKey: "g2" },
    3014: { name: "裴梓彦", colorKey: "g1" },
    3015: { name: "钱裔昕", colorKey: "g2" },
    3016: { name: "邵煜淇", colorKey: "g1" },
    3017: { name: "史心怡", colorKey: "g2" },
    3018: { name: "孙凡博", colorKey: "c1" },
    3019: { name: "孙嘉睿", colorKey: "g1" },
    3020: { name: "王乐泉", colorKey: "c3" },
    3021: { name: "王晓睿", colorKey: "g1" },
    3022: { name: "王源亿", colorKey: "c2" },
    3023: { name: "吴谦", colorKey: "c1" },
    3024: { name: "王钰涛", colorKey: "c3" },
    3025: { name: "张毓山", colorKey: "g1" },
    3026: { name: "张念之", colorKey: "g1" },
    3027: { name: "仲源成", colorKey: "g2" },
    3028: { name: "周宸熠", colorKey: "c3" },
    3029: { name: "周东发", colorKey: "c3" },
    3030: { name: "吴辰轩", colorKey: "c3" },
    3031: { name: "朱辰鸣", colorKey: "c3" },
    3032: { name: "顾王浩皓", colorKey: "g1" },
    3033: { name: "黄锦扬", colorKey: "g2" },
    3034: { name: "江南俊雄", colorKey: "g1" },
    3035: { name: "王子瑞", colorKey: "c3" },
    3036: { name: "季子谦", colorKey: "g1" },
    3037: { name: "李济慈", colorKey: "g1" },
    3038: { name: "刘轩齐", colorKey: "by" },
    3039: { name: "李星成", colorKey: "by" },
    3040: { name: "吕鸣戈", colorKey: "g2" },
    3041: { name: "聂鸿杰", colorKey: "by" },
    3042: { name: "邱彬", colorKey: "g1" },
    3043: { name: "姚心瑜", colorKey: "g2" },
    3044: { name: "杨鸿博", colorKey: "g1" },
    3045: { name: "王凯琦", colorKey: "c3" },
    3046: { name: "吴承坤", colorKey: "g1" },
    3047: { name: "王静琪", colorKey: "c3" },
    3048: { name: "邱翰林", colorKey: "c2" },
    3049: { name: "兰瑞翔", colorKey: "g1" },
    3050: { name: "田泽恩", colorKey: "by" },
    3051: { name: "张峻源", colorKey: "by" },
    3052: { name: "方铨铎", colorKey: "g1" },
    3053: { name: "刘宇翔", colorKey: "by" },
    3054: { name: "兰瑞翔", colorKey: "g1" },
    3055: { name: "唐一霄", colorKey: "g1" },
    3056: { name: "徐浩轩", colorKey: "by" },
    3057: { name: "赵元皓", colorKey: "g1" },
    3058: { name: "周裕杭", colorKey: "g2" },
    3059: { name: "张子涵", colorKey: "g1" },
    3060: { name: "曹嘉懿", colorKey: "by" },
    3061: { name: "曹晋铭", colorKey: "by" },
    3062: { name: "曾梓骞", colorKey: "by" },
    3063: { name: "柴晟", colorKey: "by" },
    3064: { name: "何旭宇", colorKey: "by" },
    3065: { name: "黄浩伦", colorKey: "by" },
    3066: { name: "黄业曦", colorKey: "by" },
    3067: { name: "李浩颐", colorKey: "by" },
    3068: { name: "李林钊", colorKey: "by" },
    3069: { name: "刘靖龙", colorKey: "by" },
    3070: { name: "刘纹熹", colorKey: "c1" },
    3071: { name: "农焱杰", colorKey: "by" },
    3072: { name: "潘胜", colorKey: "c1" },
    3073: { name: "秦文乐", colorKey: "by" },
    3074: { name: "全柏锋", colorKey: "by" },
    3075: { name: "孙美怡", colorKey: "by" },
    3076: { name: "苏忠铖", colorKey: "by" },
    3077: { name: "覃俊皓", colorKey: "by" },
    3078: { name: "魏伟霖", colorKey: "by" },
    3079: { name: "许谌杰", colorKey: "by" },
    3080: { name: "薛乐琛", colorKey: "by" },
    3081: { name: "杨广志", colorKey: "c1" },
    3082: { name: "杨睿", colorKey: "by" },
    3083: { name: "颜鑫源", colorKey: "by" },
    3084: { name: "张桓", colorKey: "by" },
    3085: { name: "张其皓", colorKey: "by" },
    3086: { name: "占文昊", colorKey: "by" },
    3087: { name: "钟昊辰", colorKey: "by" },
    3088: { name: "周楚乔", colorKey: "c1" },
  };
