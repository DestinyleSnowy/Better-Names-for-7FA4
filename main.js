...
(function () {
  ...
  const css = `
    ...
    .bn-version {
      position: relative;
      --bn-version-links-space: clamp(64px, 16vw, 140px);
    ...
    .bn-version-text {
      grid-column: 1 / -1;
      justify-self: center;
      padding: 0 var(--bn-version-links-space);
    ...
    @media (max-width: 600px) {
      ...
      .bn-version { --bn-version-links-space: clamp(48px, 22vw, 120px); }
      .bn-version-links { gap: 6px; }
  ...
  const users = {
    ...
    1271: { name: "huangsiyuan", colorKey: "g1" },
    ...
    1941: { name: "zhangjiacheng", colorKey: "g1" },
    ...
    2294: { name: "zhuochengjie", colorKey: "g1" },
